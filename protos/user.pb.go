...
type UserInfo struct {
	...
	Watchedmovies string `protobuf:"bytes,2,opt,name=watchedmovies,proto3" json:"watchedmovies,omitempty"`
}
...
var file_protos_user_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x22, 0x40, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x24,
	0x0a, 0x0d, 0x77, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x77, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x6d, 0x6f,
	...
	,
...
var file_protos_user_proto_depIdxs = []int32{
	0, // 0: user.User.GetUsers:input_type -> user.Empty
	2, // 1: user.User.GetUser:input_type -> user.Id
	1, // 2: user.User.CreateUser:input_type -> user.UserInfo
	1, // 3: user.User.UpdateUser:input_type -> user.UserInfo
	2, // 4: user.User.DeleteUser:input_type -> user.Id
	1, // 5: user.User.GetUsers:output_type -> user.UserInfo
	1, // 6: user.User.GetUser:output_type -> user.UserInfo
	2, // 7: user.User.CreateUser:output_type -> user.Id
	3, // 8: user.User.UpdateUser:output_type -> user.Status
	3, // 9: user.User.DeleteUser:output_type -> user.Status
